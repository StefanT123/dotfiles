...
sudo apt update
sudo apt install -y nginx php-cli php8.1 php8.2 php8.1-{fpm,cli,curl,gd,mbstring,mysql,zip,sqlite3,imagick} php8.2-{fpm,cli,curl,gd,mbstring,mysql,zip,sqlite3,imagick} imagemagick mariadb-server redis-server
